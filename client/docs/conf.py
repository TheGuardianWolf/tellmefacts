...
htmlhelp_basename = 'tellmefactsclientdoc'

# Grouping the document tree into LaTeX files. List of tuples
# (source start file, target name, title,
#  author, documentclass [howto, manual, or own class])
latex_documents = [
    (master_doc, 'tellmefacts-client.tex', u'tellmefacts-client Documentation',
     u'Jerry Fan', 'manual'),
]
...
man_pages = [
    (master_doc, 'tellmefacts-client', u'tellmefacts-client Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tellmefacts-client', u'tellmefacts-client Documentation',
     author, 'tellmefacts-client', 'A multiplexing client Slack bot.',
     'Miscellaneous'),
]
